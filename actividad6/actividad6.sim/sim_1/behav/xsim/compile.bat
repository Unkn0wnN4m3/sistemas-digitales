...
REM
REM Generated by Vivado on Tue Nov 18 21:33:28 -0600 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_main_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_main_vlog.prj -log xvlog.log
