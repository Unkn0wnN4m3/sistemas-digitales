...
HD_PWD='C:/Users/thisi/Documents/School/Semestre2026-1/SistemasAvanzados/vivado/floating_point_adder/floating_point_adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fp_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fp_adder.tcl -notrace
