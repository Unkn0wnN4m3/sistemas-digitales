...
REM
REM Generated by Vivado on Tue Sep 16 19:33:13 -0600 2025
...
echo "xvlog --incr --relax -L uvm -prj fp_adder_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj fp_adder_tb_vlog.prj -log xvlog.log
